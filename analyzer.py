...
"""
import sys
# This tells Python explicitly to include your working package folder
sys.path.append(r"C:\Users\Rachel\AppData\Local\Programs\Python\Python314\Lib\site-packages")

import numpy as np

# Test code
arr = np.array([1, 2, 3])
print("Success! NumPy is working. Array:", arr)
