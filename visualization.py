...
def plot_magnitude_distribution(earthquakes, save_path=None):
    """
    Description:
    ...
    plt.hist(magnitudes, bins=10, color="orange", edgecolor="black")
...
def plot_frequency_distribution(frequency_data, save_path=None):
    """
    Description:
    ...
    plt.title("Earthquake Frequency by Severity Category")
...
def plot_depth_vs_magnitude(earthquakes, save_path=None):
    """
    Description:
        Creates a scatter plot showing the relationship between earthquake
        depth and magnitude.
    ...
    depths = [earthquake.depth for earthquake in earthquakes]
    ...
    # Create scatter plot.
    plt.figure(figsize=(8, 5))
    plt.scatter(depths, magnitudes, color="red", alpha=0.6)
...
if __name__ == "__main__":
    ...
    sample_earthquakes = [
        Earthquake(6.5, "California", 36.7, -119.4, 12.5, "2025-01-15T08:30:00"),
        Earthquake(4.8, "Alaska", 61.2, -149.9, 35.2, "2025-02-10T12:15:00")
    ]

    # Generate example charts.
    plot_magnitude_distribution(sample_earthquakes)
    plot_depth_vs_magnitude(sample_earthquakes)
